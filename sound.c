...
// intended to only stop sound A if necessary. Intended to stop BG music
void stopSoundA() {
    dma[1].cnt = 0;
    REG_TM0CNT = TIMER_OFF;
    soundA.isPlaying = 0;
...
// intended to only stop sound B if necessary. Use to stop SFX before playing another SFX.
void stopSoundB() {
    dma[2].cnt = 0;
    REG_TM1CNT = TIMER_OFF;
    soundB.isPlaying = 0; 
