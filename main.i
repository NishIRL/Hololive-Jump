...
# 1 "loseScreenBG.h" 1
# 22 "loseScreenBG.h"
extern const unsigned short loseScreenBGTiles[19072];


extern const unsigned short loseScreenBGMap[1024];


extern const unsigned short loseScreenBGPal[256];
# 8 "main.c" 2
# 1 "controls.h" 1
# 22 "controls.h"
...
# 14 "main.c" 2
# 1 "level1RoughCollisionMap.h" 1
# 20 "level1RoughCollisionMap.h"
extern const unsigned short level1RoughCollisionMapBitmap[131072];
# 15 "main.c" 2
# 1 "level2BG.h" 1
# 22 "level2BG.h"
...
void goToStart() {
    ...
    DMANow(3, startScreenBGPal, ((unsigned short *)0x5000000), 512/2);
    DMANow(3, startScreenBGTiles, &((charblock *)0x6000000)[0], 21504/2);
    DMANow(3, startScreenBGMap, &((screenblock *)0x6000000)[20], 2048/2);

    DMANow(3, startScreenBGPal, ((unsigned short *)0x5000200), 512/2);
    DMANow(3, startScreenBGTiles, &((charblock *)0x6000000)[4], 21504/2);
...
void goToControls() {
    ...
    DMANow(3, controlsTiles, &((charblock *)0x6000000)[0], 24896/2);
    DMANow(3, controlsMap, &((screenblock *)0x6000000)[20], 2048/2);
    (*(volatile unsigned short *)0x4000008) = ((0) << 2) | ((20) << 8) | (1 << 7) | (0 << 14);
    hideSprites();
...
void goToGame() {
    ...
    (*(volatile unsigned short *)0x400000A) = (2 << 14) | ((0) << 2) | ((23) << 8) | (0 << 7);
    DMANow(3, level1BGPal, ((unsigned short *)0x5000000), 512/2);
    DMANow(3, level1BGTiles, &((charblock *)0x6000000)[0], 15360/2);
    DMANow(3, level1BGMap, &((screenblock *)0x6000000)[23], 4096/2);


    (*(volatile unsigned short *)0x4000008) = ((1) << 2) | ((16) << 8) | (0 << 7) | (2 << 14);
    DMANow(3, level1SceneTiles, &((charblock *)0x6000000)[1], 4640/2);
    DMANow(3, level1SceneMap, &((screenblock *)0x6000000)[16], 4096/2);


    DMANow(3, gamespritesheetPal, ((unsigned short *)0x5000200), 512/2);
    DMANow(3, gamespritesheetTiles, &((charblock *)0x6000000)[4], 32768/2);
    hideSprites();
    DMANow(3, shadowOAM, ((OBJ_ATTR *)(0x7000000)), 512);
    waitForVBlank();
...
void goToGame2() {
    ...
    (*(volatile unsigned short *)0x400000A) = (2 << 14) | ((0) << 2) | ((23) << 8) | (0 << 7);
    DMANow(3, level2BGPal, ((unsigned short *)0x5000000), 512/2);
    DMANow(3, level2BGTiles, &((charblock *)0x6000000)[0], 11488/2);
    DMANow(3, level2BGMap, &((screenblock *)0x6000000)[23], 4096/2);


    (*(volatile unsigned short *)0x4000008) = ((1) << 2) | ((16) << 8) | (0 << 7) | (2 << 14);
    DMANow(3, level2SceneTiles, &((charblock *)0x6000000)[1], 2400/2);
    DMANow(3, level2SceneMap, &((screenblock *)0x6000000)[16], 4096/2);
...
void goToGame3() {
    ...
    (*(volatile unsigned short *)0x400000A) = (2 << 14) | ((0) << 2) | ((23) << 8) | (0 << 7);
    DMANow(3, level3BGPal, ((unsigned short *)0x5000000), 512/2);
    DMANow(3, level3BGTiles, &((charblock *)0x6000000)[0], 1984/2);
    DMANow(3, level3BGMap, &((screenblock *)0x6000000)[23], 4096/2);


    (*(volatile unsigned short *)0x4000008) = ((1) << 2) | ((16) << 8) | (0 << 7) | (2 << 14);
    DMANow(3, level3SceneTiles, &((charblock *)0x6000000)[1], 3648/2);
    DMANow(3, level3SceneMap, &((screenblock *)0x6000000)[16], 4096/2);
...
void goToPause() {
    DMANow(3, pauseScreenBGPal, ((unsigned short *)0x5000000), 512/2);
    DMANow(3, pauseScreenBGTiles, &((charblock *)0x6000000)[0], 38144/2);
    DMANow(3, pauseScreenBGMap, &((screenblock *)0x6000000)[20], 2048/2);
    (*(volatile unsigned short *)0x4000008) = ((0) << 2) | ((20) << 8) | (1 << 7) | (0 << 14);
    hideSprites();
    DMANow(3, shadowOAM, ((OBJ_ATTR *)(0x7000000)), 512);
    waitForVBlank();
...
void goToWin() {
    DMANow(3, winScreenBGPal, ((unsigned short *)0x5000000), 512/2);
    DMANow(3, winScreenBGTiles, &((charblock *)0x6000000)[0], 38144/2);
    DMANow(3, winScreenBGMap, &((screenblock *)0x6000000)[20], 2048/2);
    (*(volatile unsigned short *)0x4000008) = ((0) << 2) | ((20) << 8) | (1 << 7) | (0 << 14);
    hideSprites();
    DMANow(3, shadowOAM, ((OBJ_ATTR *)(0x7000000)), 512);
    waitForVBlank();
...
void win3() {
    ...
    shadowOAM[0].attr0 = (106) | (0 << 13) | (0 << 14);
    shadowOAM[0].attr1 = (80) | (1 << 14);
    shadowOAM[0].attr2 = ((4) << 12) | ((22)*32 + (4));


    shadowOAM[1].attr0 = (106) | (0 << 13) | (0 << 14);
    shadowOAM[1].attr1 = (90) | (1 << 14);
    shadowOAM[1].attr2 = ((4) << 12) | ((20)*32 + (4));


    shadowOAM[2].attr0 = (105) | (0 << 13) | (0 << 14);
    shadowOAM[2].attr1 = (100) | (1 << 14);
    shadowOAM[2].attr2 = ((4) << 12) | ((20)*32 + (28));


    shadowOAM[3].attr0 = (105) | (0 << 13) | (0 << 14);
    shadowOAM[3].attr1 = (110) | (1 << 14);
    shadowOAM[3].attr2 = ((4) << 12) | ((22)*32 + (2));


    shadowOAM[4].attr0 = (105) | (0 << 13) | (0 << 14);
    shadowOAM[4].attr1 = (120) | (1 << 14);
    shadowOAM[4].attr2 = ((4) << 12) | ((20)*32 + (8));


    shadowOAM[5].attr0 = (105) | (0 << 13) | (0 << 14);
    shadowOAM[5].attr1 = (130) | (1 << 14);
    shadowOAM[5].attr2 = ((4) << 12) | ((24)*32 + ((finalScore * 2)));
...
void goToLose() {
    DMANow(3, loseScreenBGPal, ((unsigned short *)0x5000000), 512/2);
    DMANow(3, loseScreenBGTiles, &((charblock *)0x6000000)[0], 38144/2);
    DMANow(3, loseScreenBGMap, &((screenblock *)0x6000000)[20], 2048/2);
    (*(volatile unsigned short *)0x4000008) = ((0) << 2) | ((20) << 8) | (1 << 7) | (0 << 14);
    hideSprites();
    DMANow(3, shadowOAM, ((OBJ_ATTR *)(0x7000000)), 512);
    waitForVBlank();
